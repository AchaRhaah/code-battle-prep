...
function Stats() {
  return (
    <div className=" flex flex-col md:flex-row  w-full  items-center justify-center py-4 gap-6 px-12 ">
      <StatsCard
        icon={<AiFillFile className="text-green text-[1.8rem]" />}
        text="1,000+ free best online courses"
      />
      <StatsCard
        icon={<BsFillPersonFill className="text-pink  text-[1.8rem]" />}
        text="1,000+ experienced and expert mentors"
      />
      <StatsCard
        icon={<AiFillMessage className="text-green text-[1.8rem]" />}
